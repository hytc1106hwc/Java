...
public class ToGsonTest {
	...
	public static void main(String[] args) {
    	...
    	// JSON --> System.Out
    	gson.toJson(json_with_generic, System.out);
    	
    	
    	//JSON --> File
    	Writer writer = null;
    	try {
    		writer = new FileWriter(new File("out1.json"));
    	...
    	// use OutputStreamWriter to convert byte streams to character streams
